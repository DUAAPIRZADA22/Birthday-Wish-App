...
export default function BirthdayWish() {
  ...
  return (
    <div
      className="min-h-screen bg-[url('/bday.jpg')] bg-cover bg-center flex items-center justify-center p-4"
    >
      <motion.div
      ...
      <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black ">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-black">Happy 23rd Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-gray-600">Duaa Pirzada</CardDescription>
            <p className="text-lg text-gray-500">February 17th</p>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center">
            <Button
              className="bg-red-800 text-white hover:bg-black transition-all duration-300"
              onClick={celebrate}
